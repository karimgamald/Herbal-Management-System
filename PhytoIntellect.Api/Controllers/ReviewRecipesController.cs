...
public class AiRecipeReviewsController(IReviewRecipeService reviewService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetAllReviewsByAdmin([FromQuery] RequestFilters filters, CancellationToken cancellationToken)
    {
    ...
    [Authorize(Roles = AppRoles.Admin)]
    public async Task<IActionResult> DeleteReviewByAdmin(int reviewId, CancellationToken cancellationToken)
    {
